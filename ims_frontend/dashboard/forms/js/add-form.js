...
class AddComponentForm {
    ...
    updateComponentSpecification() {
        ...
        console.log('Component specification updated:', this.componentSpecification);
    }
        ...
        try {
            ...
            if (jsonPaths[componentType]) {
                ...
                if (response.ok) {
                    ...
                    console.log(`Loaded JSON data for ${componentType}:`, this.jsonData);
                } else {
    ...
    handleBrandChange(selectedBrand) {
        ...
        console.log(`Brand selected: ${selectedBrand} for ${this.currentComponentType}`);
    ...
    populateSeriesDropdown(selectedBrand) {
        ...
        console.log(`Available series for ${selectedBrand}:`, series);
    ...
    populateModelDropdown(selectedBrand, selectedSeries = null) {
        ...
        console.log('Filtered data for models:', filteredData);
        ...
        models.forEach((model, index) => {
            ...
            if (modelName) {
                ...
                console.log(`Added model: ${modelName} with UUID: ${uuid}`);
            }
        });
    ...
    displayComponentDetails(modelData) {
        ...
        if (this.currentComponentType === 'cpu') {
            details = {
                ...
                'Base Frequency': modelData.base_frequency_GHz ? `${modelData.base_frequency_GHz}GHz` : 'N/A',
                'Max Frequency': modelData.max_frequency_GHz ? `${modelData.max_frequency_GHz}GHz` : 'N/A',
                'TDP': modelData.tdp_W ? `${modelData.tdp_W}W` : 'N/A',
            ...
            // Generic details
            details = {
                'Model': modelData.model || modelData.name || 'N/A',
                'Brand': modelData._brand || 'N/A',
                'Series': modelData._series || 'N/A'
            };
        }
